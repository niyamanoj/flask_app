...
# Load Dataset
df = pd.read_csv("C:/Users/manoj/OneDrive/Desktop/ai/balanced_diabetes_data2.csv")
...
svm_model_dia = SVC(probability=True)
svm_model_dia.fit(X_train_scaled,y_train_smote)

import joblib
import pickle
# Save the trained model (SVM model in this case)
joblib.dump(svm_model_dia, 'dia_model.pkl')
