...
# Load Dataset
df = pd.read_csv("C:/Users/manoj/Downloads/Cardiovascular_Disease_Health_Data.csv")
...
svm_model_card = SVC(probability=True)
svm_model_card.fit(X_train_scaled,y_train_smote)
import joblib
import pickle
# Save the trained model (SVM model in this case)
joblib.dump(svm_model_card, 'card_model.pkl')
